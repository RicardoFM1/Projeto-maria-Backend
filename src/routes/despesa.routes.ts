...
import { AtualizarDespesasController, CreateDespesaController, deleteDespesasController, GetAllDespesasController } from "../controllers/despesas.controllers";
...
despesaRoutes.patch("/:id", AtualizarDespesasController)
