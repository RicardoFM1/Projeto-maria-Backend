...
export const CreateVendaController = async(req:Request, res:Response):Promise<Response> =>{
    ...
    export const GetVendaByIdController = async(req:Request, res:Response):Promise<Response> =>{
        const vendaId = req.params.id
        const venda = await GetVendaByIdService(vendaId)

        return res.status(200).json(venda)
    }
    export const GetProdutoVendaByIdController = async(req:Request, res:Response):Promise<Response> =>{
